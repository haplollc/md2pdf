...
public struct AddPageSplitSpaceKey: EnvironmentKey {
    public static let defaultValue = false
}

extension EnvironmentValues {
  public var addPageSplitSpace: Bool {
    get { self[AddPageSplitSpaceKey.self] }
    set { self[AddPageSplitSpaceKey.self] = newValue }
  }
}

extension View {
  public func addPageSplitSpace(_ value: Bool) -> some View {
    environment(\.addPageSplitSpace, value)
  }
}
